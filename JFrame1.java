...
public class JFrame1 extends JFrame implements ActionListener {
    ...
    public JFrame1() {
        ...
        // 受付番号表示ラベルを追加
        JLabel displayRNumberLabel = new JLabel("現在の受付番号:");
        displayRNumberLabel.setFont(new Font("MS Gothic", Font.BOLD, 20)); // 日本語フォントを指定

        rNumberLabel = new JLabel(String.valueOf(rNumber));  // 初期値を表示
